...
class SurveyReportBase extends StatefulWidget {
  final String reportType;

  const SurveyReportBase({required this.reportType, Key? key})
      : super(key: key);

  @override
  State<SurveyReportBase> createState() => _SurveyReportBaseState();
}

class _SurveyReportBaseState extends State<SurveyReportBase> {
...
Future<void> _submitReport() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
         title: HeadingText(text: "التقارير السنوية" , textColor: Colors.white,),
                 centerTitle: true,
